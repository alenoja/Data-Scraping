"""
This is the doctring for the mc module. We can show how to use the code in here.
This is like a comment, but it is available for inspection
>>> m = Markov('ab')
>>> m.predict('a')
...
def get_table(text, size=1):
    """
    This is the docstring for get_table function
    >>> get_table('ab')
    {'a': {'b': 1}}
    """
    result = {}
...
def main(args):
    ...
    ap.add_argument('-s', '--size', help='Size of chain(default 1)',
                    default=1, type=int)
